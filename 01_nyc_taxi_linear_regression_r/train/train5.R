...
print("About to generate model Model 5")
mod = lm(totalAmount ~ vendorID*(tripDistance + passengerCount + month_num + day_of_month + day_of_week + hour_of_day), data = df_train)
